...
namespace RepositaryLayer_BlogSystem.Data.Migrations
{
    ...
    [Migration("20250105160510_add relation with user")]
    partial class addrelationwithuser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreLayer_BlogSystem.Entities.Identity.AppUser", b =>
                {
            ...
            modelBuilder.Entity("CoreLayer_BlogSystem.Entities.BlogPost", b =>
                {
                    b.HasOne("CoreLayer_BlogSystem.Entities.Identity.AppUser", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CoreLayer_BlogSystem.Entities.Identity.AppUser", null)
                        .WithMany()
